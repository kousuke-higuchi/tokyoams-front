    ...
    <v-expansion-panel @click="onPanelIsExtendedChanged">
      <v-expansion-panel-title>
        ...
        <v-row justify="end" class="mr-2">
          <v-btn color="primary" size="small" variant="contained-flat" href="/udgwalkway">
            一覧に戻る
          </v-btn>
        </v-row>
      </v-expansion-panel-title>
...
const baseUrl = `/udgwalkway/${route.params.id}`
const selectFacility = ref("0001");
const isOpen = ref(false);
const buttons01 = [
    { title: '様式-T1', props: { to: `${baseUrl}/ledgerT1` } },
    { title: '様式-T1-2', props: { to: `${baseUrl}/ledgerT1-2` } },
    { title: '様式-T2', props: { to: `${baseUrl}/ledgerT2` } },
    { title: '様式-T3', props: { to: `${baseUrl}/ledgerT3` } },
];
const buttons02 = [
    { title: '様式-T8', props: { to: `${baseUrl}/protocolT8` } },
    { title: '様式-T9', props: { to: `${baseUrl}/protocolT9` } },
    { title: '様式-T10', props: { to: `${baseUrl}/protocolT10` } },
    { title: '様式-T11', props: { to: `${baseUrl}/protocolT11` } },
