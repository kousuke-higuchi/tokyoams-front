...
export default defineComponent({
  ...
  mounted: function(){
    ...
    this.rows = roadsignJson;
    this.rowsOverlay = roadsignJson;
  },
  methods: {
    clickFind(){
		...
		clickFAdvancedSearch(){
			console.debug('clickFAdvancedSearch' + this.showFind);
      this.showFind = !this.showFind;
		},
		clickOutputCSV(){
    ...
    clickMarkerListRow(e){
      const roadsign = e.row;
      console.debug('clickMarkerList',roadsign);
    },
