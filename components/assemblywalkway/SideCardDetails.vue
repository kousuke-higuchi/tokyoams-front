...
export default defineComponent({
  ...
  data() {
    return {
      ...
      tabSide: 'ledger',
      btnLedger: [
        { title: '様式-1', props: { to: `/assemblywalkway/${this.$route.params.id}/ledger1` } },
        { title: '様式-1 補修調書', props: { to: `/assemblywalkway/${this.$route.params.id}/ledger1Repair` } },
        { title: '様式-1\'', props: { to: `/assemblywalkway/${this.$route.params.id}/ledger1Dush` } },
        { title: '様式-2', props: { to: `/assemblywalkway/${this.$route.params.id}/ledger2` } },
        { title: '様式-3', props: { to: `/assemblywalkway/${this.$route.params.id}/ledger3` } },
      ],
      btnProtocol: [
        { title: '様式-8', props: { to: `/assemblywalkway/${this.$route.params.id}/protocol8` } },
        { title: '様式-9', props: { to: `/assemblywalkway/${this.$route.params.id}/protocol9` } },
        { title: '様式-10', props: { to: `/assemblywalkway/${this.$route.params.id}/protocol10` } },
        { title: '判定表', props: { to: `/assemblywalkway/${this.$route.params.id}/decision` } },
        { title: '判定表(附属物)', props: { to: `/assemblywalkway/${this.$route.params.id}/appendageDecision` } },
      ],
      btnNation: [
        { title: '様式・国1', props: { to: `/assemblywalkway/${this.$route.params.id}/nation1` } },
        { title: '様式・国2', props: { to: `/assemblywalkway/${this.$route.params.id}/nation2` } },
        { title: '様式・国3', props: { to: `/assemblywalkway/${this.$route.params.id}/nation3` } },
        { title: '様式・国4', props: { to: `/assemblywalkway/${this.$route.params.id}/nation4` } },
        { title: '様式・国5A', props: { to: `/assemblywalkway/${this.$route.params.id}/nation5A` } },
        { title: '様式・国5B', props: { to: `/assemblywalkway/${this.$route.params.id}/nation5B` } },
        { title: '様式・国5C', props: { to: `/assemblywalkway/${this.$route.params.id}/nation5C` } },
      ],
      noteColumns: [
        {
