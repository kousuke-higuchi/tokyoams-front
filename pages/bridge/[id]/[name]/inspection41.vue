          ...
          <v-row no-gutters>
            <v-table density="compact" class="ledger">
              <tbody>
                ...
                <tr v-for="item in uppers" :key="item">
                ...
                <tr v-for="item in lowers" :key="item">
                  <th class="text-center">{{ item }}</th>
                  <td class="text-center"></td>
                  <td></td>
                  <td></td>
...
export default defineComponent({
  data() {
    return {
      ...
      lowers: ['基礎', '躯体', '基礎'],
      items: ['支承', '高欄', '防護柵', '地覆', '舗装', '伸縮装置', '排水設備', '落橋防止装置', '点検設備', 'しゃ音設備', '照明設備', '添架物', '耐久性(α)', '安全性(β)'],
    }
  },
  mounted: function () {
