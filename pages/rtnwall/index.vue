    ...
    <v-card-text>
      <v-window v-model="tab">
        ...
        <v-window-item value="list">
          ...
          <div>
            <vue-good-table :columns="columns" :rows="rtnwalls" :pagination-options="{
              enabled: true
            }">
        ...
        <v-window-item value="map">
          ...
          <v-card style="height:78vh; width: 94vw">
            <ams-map :zoom="zoom" :center="center" :markers="rtnwalls" marker-title="facillityname"
