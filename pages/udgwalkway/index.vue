<template>
  ...
  <v-card>
            ...
            <vue-good-table :columns="columns" :rows="utilitytunnels" :pagination-options="{
              ...
              <template #table-row="props">
                <span v-if="props.column.field == 'facillityname'">
                  <nuxt-link :to="`/udgwalkway/${props.row.id}/ledgerT1`">{{ props.formattedRow[props.column.field] }}</nuxt-link>
                </span>
    ...
    <underground-walkway-search-condition-dialog v-model:isOpen="showFind" />

  </v-card>
</template>

<script lang="ts">
import utilitytunnelJson from "../../assets/undergroundWalkway.json"
...
export default defineComponent({
  ...
  methods: {
    ...
    clickMarker(m) {
      ...
      navigateTo(`/udgwalkway/${m.id}/ledgerT1`,m);
    }
  }
})
</script>